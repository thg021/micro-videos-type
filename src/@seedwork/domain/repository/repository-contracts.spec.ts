...
describe('SearchParams Unit tests', () => {
  ...
  test('per page props', () => {
    const arrange = [
      ...
      { per_page: 3.15, expect: 15 },
      { per_page: -1, expect: 15 },
      { per_page: 1, expect: 1 },
      { per_page: 99, expect: 99 },
    ] as any
  ...
  test('sort dir props', () => {
    ...
    const arrange = [
      ...
      { sort: null, expect: null },
      { sort: undefined, expect: null },
      { sort: 'field', expect: 'asc' },
      { sort: true, expect: 'asc' },
      { sort: false, expect: 'asc' },
      { sort: {}, expect: 'asc' },
      { sort: 'field', sort_dir: null, expect: 'asc' },
      { sort: 'field', sort_dir: undefined, expect: 'asc' },
      { sort: 'field', sort_dir: '', expect: 'asc' },
      { sort: 'field', sort_dir: {}, expect: 'asc' },
      { sort: 'field', sort_dir: [], expect: 'asc' },
      { sort: 'field', sort_dir: 'asc', expect: 'asc' },
      { sort: 'field', sort_dir: 'desc', expect: 'desc' },
      { sort: 'field', sort_dir: 'faker', expect: 'asc' },
      { sort: 'field', sort_dir: 'FAKER', expect: 'asc' },
      { sort: 'field', sort_dir: 'DESC', expect: 'desc' },
    ] as any
